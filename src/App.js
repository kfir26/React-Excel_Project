...
class App extends Component {
  ...
  openNewPage = (chosenItem) => {
    const url = chosenItem === "github" ? "https://github.com/kfir26" : "https://medium.com/@ashishd751/render-and-display-excel-sheets-on-webpage-using-react-js-af785a5db6a7";
      ...
      <div>
        <div>
          <Jumbotron className="jumbotron-background">          
              <h1 className="display-3">React - Interview Task</h1>
              <p className="lead">Welcome to the excel uploader</p>  
              <Button className="primary jumbotron-button" onClick={this.openNewPage.bind(this,"github")}>GitHub</Button>{' '}
              <hr className="my-2" />
              <p>Developed with <span className="fa fa-heart"></span> by kfir paniri</p>
          </Jumbotron>
        </div>
        <Container>
        <form>
        ...
        <div>
          <Card body outline color="secondary" className="restrict-card">
              ...
              <OutTable data={this.state.rows} columns={this.state.cols} tableClassName="ExcelTable2021" tableHeaderRowClass="heading" />
